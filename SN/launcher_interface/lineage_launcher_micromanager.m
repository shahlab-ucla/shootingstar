function varargout = lineage_launcher_micromanager(varargin)
%lineage_launcher_micromanager M-file for lineage_launcher_micromanager.fig
%      lineage_launcher_micromanager, by itself, creates a new lineage_launcher_micromanager or raises the existing
%      singleton*.
%
%      H = lineage_launcher_micromanager returns the handle to a new lineage_launcher_micromanager or the handle to
%      the existing singleton*.
%
%      lineage_launcher_micromanager('Property','Value',...) creates a new lineage_launcher_micromanager using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to lineage_launcher_micromanager_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      lineage_launcher_micromanager('CALLBACK') and lineage_launcher_micromanager('CALLBACK',hObject,...) call the
%      local function named CALLBACK in lineage_launcher_micromanager.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help lineage_launcher_micromanager

% Last Modified by GUIDE v2.5 16-Mar-2020 08:36:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @lineage_launcher_micromanager_OpeningFcn, ...
                   'gui_OutputFcn',  @lineage_launcher_micromanager_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before lineage_launcher_micromanager is made visible.
function lineage_launcher_micromanager_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line outputname for lineage_launcher_micromanager
handles.outputname = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lineage_launcher_micromanager wait for user response (see UIRESUME)
...
function varargout = lineage_launcher_micromanager_OutputFcn(hObject, eventdata, handles)
...
detect_track_driver_allmatlab_micromanager(parameterfilenames{i},embryodir,handles.embryoname,[suffix,num2str(i)],outputdirectory,points,false,'',str2double(get(handles.endtime,'String')));%,lineageparameterfile);
end
