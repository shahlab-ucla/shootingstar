function varargout = lineage_launcher_ACTIVITY(varargin)
%lineage_launcher_ACTIVITY M-file for lineage_launcher_ACTIVITY.fig
%      lineage_launcher_ACTIVITY, by itself, creates a new lineage_launcher_ACTIVITY or raises the existing
%      singleton*.
%
%      H = lineage_launcher_ACTIVITY returns the handle to a new lineage_launcher_ACTIVITY or the handle to
%      the existing singleton*.
%
%      lineage_launcher_ACTIVITY('Property','Value',...) creates a new lineage_launcher_ACTIVITY using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to lineage_launcher_ACTIVITY_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      lineage_launcher_ACTIVITY('CALLBACK') and lineage_launcher_ACTIVITY('CALLBACK',hObject,...) call the
%      local function named CALLBACK in lineage_launcher_ACTIVITY.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help lineage_launcher_ACTIVITY

% Last Modified by GUIDE v2.5 25-May-2017 09:13:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @lineage_launcher_ACTIVITY_OpeningFcn, ...
                   'gui_OutputFcn',  @lineage_launcher_ACTIVITY_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before lineage_launcher_ACTIVITY is made visible.
function lineage_launcher_ACTIVITY_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line outputname for lineage_launcher_ACTIVITY
handles.outputname = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lineage_launcher_ACTIVITY wait for user response (see UIRESUME)
...
function varargout = lineage_launcher_ACTIVITY_OutputFcn(hObject, eventdata, handles)
...
detect_track_driver_allmatlab_ACTIVITY(parameterfilenames{i},embryodir,handles.embryoname,[suffix,num2str(i)],outputdirectory,points,false,'');%,lineageparameterfile);
