...
% Last Modified by GUIDE v2.5 27-May-2014 10:36:39
...
job = batch('detect_track_driver_allmatlab_online',0,{parameterfilenames{i},embryodir,handles.embryoname,[suffix,num2str(i)],outputdirectory,points,false,AT,NM});%,lineageparameterfile);
...
iAxis = handles.CustomAxis.String;
AT.buildTree(true);
