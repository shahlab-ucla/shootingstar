...
function detect_track_driver_allmatlab_REALTIME_fish_5(parameterfile,embryodir,embryonumber,suffix,outputdirectory,polygon_points,isred,TargetCell)
                ...
                if persistance(ind)>=3
                    ...
                    if sum(strcmp(current_name,names))>0
                        if killed(ind)==0 && used==0;
                            killed(ind)=1;
                            used=1;
                            fid = fopen('C:\Users\shahp2\Desktop\MicroPointTarget\coords_5.ini','w');
                            fid2 = fopen('C:\Users\shahp2\Desktop\MicroPointTarget\log_5.txt','a');
