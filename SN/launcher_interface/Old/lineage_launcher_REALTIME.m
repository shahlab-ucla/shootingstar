function varargout = lineage_launcher_REALTIME(varargin)
%lineage_launcher_REALTIME M-file for lineage_launcher_REALTIME.fig
%      lineage_launcher_REALTIME, by itself, creates a new lineage_launcher_REALTIME or raises the existing
%      singleton*.
%
%      H = lineage_launcher_REALTIME returns the handle to a new lineage_launcher_REALTIME or the handle to
%      the existing singleton*.
%
%      lineage_launcher_REALTIME('Property','Value',...) creates a new lineage_launcher_REALTIME using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to lineage_launcher_REALTIME_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      lineage_launcher_REALTIME('CALLBACK') and lineage_launcher_REALTIME('CALLBACK',hObject,...) call the
%      local function named CALLBACK in lineage_launcher_REALTIME.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help lineage_launcher_REALTIME

% Last Modified by GUIDE v2.5 16-Jul-2015 16:04:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @lineage_launcher_REALTIME_OpeningFcn, ...
                   'gui_OutputFcn',  @lineage_launcher_REALTIME_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before lineage_launcher_REALTIME is made visible.
function lineage_launcher_REALTIME_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line outputname for lineage_launcher_REALTIME
handles.outputname = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lineage_launcher_REALTIME wait for user response (see UIRESUME)
...
function varargout = lineage_launcher_REALTIME_OutputFcn(hObject, eventdata, handles)
...
detect_track_driver_allmatlab_REALTIME(parameterfilenames{i},embryodir,handles.embryoname,[suffix,num2str(i)],outputdirectory,points,false,'');%,lineageparameterfile);
