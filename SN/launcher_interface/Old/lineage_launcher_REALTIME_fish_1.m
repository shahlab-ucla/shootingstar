function varargout = lineage_launcher_REALTIME_fish_1(varargin)
%lineage_launcher_REALTIME_fish_1 M-file for lineage_launcher_REALTIME_fish_1.fig
%      lineage_launcher_REALTIME_fish_1, by itself, creates a new lineage_launcher_REALTIME_fish_1 or raises the existing
%      singleton*.
%
%      H = lineage_launcher_REALTIME_fish_1 returns the handle to a new lineage_launcher_REALTIME_fish_1 or the handle to
%      the existing singleton*.
%
%      lineage_launcher_REALTIME_fish_1('Property','Value',...) creates a new lineage_launcher_REALTIME_fish_1 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to lineage_launcher_REALTIME_fish_1_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      lineage_launcher_REALTIME_fish_1('CALLBACK') and lineage_launcher_REALTIME_fish_1('CALLBACK',hObject,...) call the
%      local function named CALLBACK in lineage_launcher_REALTIME_fish_1.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help lineage_launcher_REALTIME_fish_1

% Last Modified by GUIDE v2.5 02-Sep-2016 11:53:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @lineage_launcher_REALTIME_fish_1_OpeningFcn, ...
                   'gui_OutputFcn',  @lineage_launcher_REALTIME_fish_1_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before lineage_launcher_REALTIME_fish_1 is made visible.
function lineage_launcher_REALTIME_fish_1_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line outputname for lineage_launcher_REALTIME_fish_1
handles.outputname = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lineage_launcher_REALTIME_fish_1 wait for user response (see UIRESUME)
...
function varargout = lineage_launcher_REALTIME_fish_1_OutputFcn(hObject, eventdata, handles)
...
detect_track_driver_allmatlab_REALTIME_fish_1(parameterfilenames{i},embryodir,handles.embryoname,[suffix,num2str(i)],outputdirectory,points,false,'');%,lineageparameterfile);
