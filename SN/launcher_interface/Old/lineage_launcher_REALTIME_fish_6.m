function varargout = lineage_launcher_REALTIME_fish_6(varargin)
%lineage_launcher_REALTIME_fish_6 M-file for lineage_launcher_REALTIME_fish_6.fig
%      lineage_launcher_REALTIME_fish_6, by itself, creates a new lineage_launcher_REALTIME_fish_6 or raises the existing
%      singleton*.
%
%      H = lineage_launcher_REALTIME_fish_6 returns the handle to a new lineage_launcher_REALTIME_fish_6 or the handle to
%      the existing singleton*.
%
%      lineage_launcher_REALTIME_fish_6('Property','Value',...) creates a new lineage_launcher_REALTIME_fish_6 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to lineage_launcher_REALTIME_fish_6_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      lineage_launcher_REALTIME_fish_6('CALLBACK') and lineage_launcher_REALTIME_fish_6('CALLBACK',hObject,...) call the
%      local function named CALLBACK in lineage_launcher_REALTIME_fish_6.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help lineage_launcher_REALTIME_fish_6

% Last Modified by GUIDE v2.5 06-Oct-2016 10:07:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @lineage_launcher_REALTIME_fish_6_OpeningFcn, ...
                   'gui_OutputFcn',  @lineage_launcher_REALTIME_fish_6_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before lineage_launcher_REALTIME_fish_6 is made visible.
function lineage_launcher_REALTIME_fish_6_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line outputname for lineage_launcher_REALTIME_fish_6
handles.outputname = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lineage_launcher_REALTIME_fish_6 wait for user response (see UIRESUME)
...
function varargout = lineage_launcher_REALTIME_fish_6_OutputFcn(hObject, eventdata, handles)
...
detect_track_driver_allmatlab_REALTIME_fish_6(parameterfilenames{i},embryodir,handles.embryoname,[suffix,num2str(i)],outputdirectory,points,false,'');%,lineageparameterfile);
