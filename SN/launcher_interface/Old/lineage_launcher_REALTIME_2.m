function varargout = lineage_launcher_REALTIME_2(varargin)
%lineage_launcher_REALTIME_2 M-file for lineage_launcher_REALTIME_2.fig
%      lineage_launcher_REALTIME_2, by itself, creates a new lineage_launcher_REALTIME_2 or raises the existing
%      singleton*.
%
%      H = lineage_launcher_REALTIME_2 returns the handle to a new lineage_launcher_REALTIME_2 or the handle to
%      the existing singleton*.
%
%      lineage_launcher_REALTIME_2('Property','Value',...) creates a new lineage_launcher_REALTIME_2 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to lineage_launcher_REALTIME_2_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      lineage_launcher_REALTIME_2('CALLBACK') and lineage_launcher_REALTIME_2('CALLBACK',hObject,...) call the
%      local function named CALLBACK in lineage_launcher_REALTIME_2.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help lineage_launcher_REALTIME_2

% Last Modified by GUIDE v2.5 30-Mar-2016 09:31:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @lineage_launcher_REALTIME_2_OpeningFcn, ...
                   'gui_OutputFcn',  @lineage_launcher_REALTIME_2_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before lineage_launcher_REALTIME_2 is made visible.
function lineage_launcher_REALTIME_2_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line outputname for lineage_launcher_REALTIME_2
handles.outputname = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lineage_launcher_REALTIME_2 wait for user response (see UIRESUME)
...
function varargout = lineage_launcher_REALTIME_2_OutputFcn(hObject, eventdata, handles)
...
detect_track_driver_allmatlab_REALTIME_2(parameterfilenames{i},embryodir,handles.embryoname,[suffix,num2str(i)],outputdirectory,points,false,'');%,lineageparameterfile);
