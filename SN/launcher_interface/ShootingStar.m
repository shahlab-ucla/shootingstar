function varargout = ShootingStar(varargin)
%ShootingStar M-file for ShootingStar.fig
%      ShootingStar, by itself, creates a new ShootingStar or raises the existing
%      singleton*.
%
%      H = ShootingStar returns the handle to a new ShootingStar or the handle to
%      the existing singleton*.
%
%      ShootingStar('Property','Value',...) creates a new ShootingStar using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to ShootingStar_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      ShootingStar('CALLBACK') and ShootingStar('CALLBACK',hObject,...) call the
%      local function named CALLBACK in ShootingStar.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help ShootingStar

% Last Modified by GUIDE v2.5 02-Nov-2016 11:22:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ShootingStar_OpeningFcn, ...
                   'gui_OutputFcn',  @ShootingStar_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before ShootingStar is made visible.
function ShootingStar_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line outputname for ShootingStar
handles.outputname = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes ShootingStar wait for user response (see UIRESUME)
...
function varargout = ShootingStar_OutputFcn(hObject, eventdata, handles)
